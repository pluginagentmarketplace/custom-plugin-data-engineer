...
This guide provides comprehensive documentation for the **etl-tools** skill in the custom-plugin-data-engineer plugin.
...
```bash
# Invoke the skill
claude "etl-tools - [your task description]"

# Example
claude "etl-tools - analyze the current implementation"
```
...
def implement_etl_tools(input_data):
    """
    Implement etl-tools functionality.

...
This guide provides comprehensive documentation for the **big-data** skill in the custom-plugin-data-engineer plugin.
...
```bash
# Invoke the skill
claude "big-data - [your task description]"

# Example
claude "big-data - analyze the current implementation"
```
...
def implement_big_data(input_data):
    """
    Implement big-data functionality.

...
This guide provides comprehensive documentation for the **api-development** skill in the custom-plugin-data-engineer plugin.
...
```bash
# Invoke the skill
claude "api-development - [your task description]"

# Example
claude "api-development - analyze the current implementation"
```
...
def implement_api_development(input_data):
    """

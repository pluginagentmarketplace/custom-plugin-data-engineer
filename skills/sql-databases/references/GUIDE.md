...
This guide provides comprehensive documentation for the **sql-databases** skill in the custom-plugin-data-engineer plugin.
...
```bash
# Invoke the skill
claude "sql-databases - [your task description]"

# Example
claude "sql-databases - analyze the current implementation"
```
...
def implement_sql_databases(input_data):
    """
    Implement sql-databases functionality.

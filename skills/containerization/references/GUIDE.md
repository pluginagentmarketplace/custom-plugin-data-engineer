...
This guide provides comprehensive documentation for the **containerization** skill in the custom-plugin-data-engineer plugin.
...
```bash
# Invoke the skill
claude "containerization - [your task description]"

# Example
claude "containerization - analyze the current implementation"
```
...
def implement_containerization(input_data):
    """
    Implement containerization functionality.

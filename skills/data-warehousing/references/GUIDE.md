...
This guide provides comprehensive documentation for the **data-warehousing** skill in the custom-plugin-data-engineer plugin.
...
```bash
# Invoke the skill
claude "data-warehousing - [your task description]"

# Example
claude "data-warehousing - analyze the current implementation"
```
...
def implement_data_warehousing(input_data):
    """
    Implement data-warehousing functionality.
